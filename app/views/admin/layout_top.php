...
<div class="admin-layout">
    ...
    <aside class="admin-sidebar" id="admin-sidebar">
        ...
        <a href="<?= ADMIN_URL ?>/quantumvault" class="nav-item <?= str_contains($_SERVER['REQUEST_URI'], '/quantumvault') ? 'active' : '' ?>">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="12" cy="12" r="4"/><path d="M12 8v8M8 12h8"/></svg>
            QuantumVault
        </a>
